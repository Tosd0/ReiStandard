...
接入过程中如果发现 SDK 应该暴露的能力没暴露、接口设计不合理、或者处理方式有问题，**可以直接向我们反馈，以免花功夫在应用层绕过或被迫 monkey-patch**。

- 小修改、明显的 Bug → 直接提 PR
- 大改动、需要讨论的设计变更 → 先开 Issue 聊

这个项目就是在更多的 Issue 和 PR 中成长的。目前的设计虽然在项目中跑通了，但可能不足以覆盖所有的项目需要的能力。比起各自 fork 魔改，还希望大家把问题推回上游，以便所有人的开发和项目未来更成熟的发展！🥰
