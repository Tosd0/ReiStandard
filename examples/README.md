...
> | `avatarUrl` 软清空（不合法值 `console.warn` + 置空，不再 400 整个任务） | server 2.3.3 / 2.4.0 · instant 0.7.1 / 0.8.0 · client 2.2.4 / 2.3.0 | 只检 `new URL(...)` 能 parse；`data:` base64 头像会进库再触发下游 413 |
>
