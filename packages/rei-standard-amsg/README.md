...
| Package | 版本 | 用途 | 文档 |
|---------|------|------|------|
| `@rei-standard/amsg-server` | `2.0.1` | 服务端标准 handlers、Blob 租户配置与 token 鉴权 | [server README](https://github.com/Tosd0/ReiStandard/blob/main/packages/rei-standard-amsg/server/README.md) |
